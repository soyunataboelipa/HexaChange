(() => {
  ...
  const HOST_LEFT_KEY = "hexachange_host_left";
  ...
  // ===== Modal host desconectado =====
  const hostLeftOverlay = $("#hostLeftOverlay");
  const hostLeftModal = $("#hostLeftModal");
  const hostLeftOk = $("#hostLeftOk");
  ...
  function openHostLeftModal() {
    if (!hostLeftOverlay || !hostLeftModal) return;
    hostLeftOverlay.classList.add("show");
    hostLeftModal.classList.add("show");
    hostLeftModal.setAttribute("aria-hidden", "false");
  }

  function closeHostLeftModal() {
    if (!hostLeftOverlay || !hostLeftModal) return;
    hostLeftOverlay.classList.remove("show");
    hostLeftModal.classList.remove("show");
    hostLeftModal.setAttribute("aria-hidden", "true");
  }
  ...
  function loadConfig() {
    ...
    if (localStorage.getItem(HOST_LEFT_KEY)) {
      localStorage.removeItem(HOST_LEFT_KEY);
      openHostLeftModal();
    }
  }
  ...
  if (hostLeftOverlay) hostLeftOverlay.addEventListener("click", closeHostLeftModal);
  if (hostLeftOk) hostLeftOk.addEventListener("click", closeHostLeftModal);
